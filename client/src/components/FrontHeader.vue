    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
      <router-link class="navbar-brand" active-class="active" to="/front">
        <img
          ...
          loading="lazy"
        />
        <span class="font1">&nbsp;ระบบจองห้องพักโรงเเรม พิษณุโลก</span>
      </router-link>
      <button
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav mr-auto">
          ...
          <li class="nav-item active" v-if="isUserLoggedIn">
            <router-link class="nav-link" active-class="active" to="/treasury"
              ><span class="font2" style="color: #fff"
                ><i class="fas fa-boxes"></i> โรงเเรมห้องพัก</span
              ></router-link
            >
          </li>
          <li class="nav-item active" v-if="isUserLoggedIn">
            <router-link
              ...
              to="/borrow/create"
              ><span class="font2" style="color: #fff"
                ><i class="fas fa-clipboard-list"></i> จองวันพัก</span
              ></router-link
            >
          </li>
          <li class="nav-item active" v-if="isUserLoggedIn">
            <router-link
              ...
              to="/borrow/status"
              ><span class="font2" style="color: #fff"
                ><i class="fas fa-list-ul"></i> วันเข้าห้องพัก & วันออกหห้องพัก</span
              ></router-link
            >
          </li>
          ...
          >
            <a
              ...
              ><span class="font2" style="color: #fff"><i class="fas fa-user-plus"></i> ลงทะเบียน</span></a
            >
          </li>
        ...
        <li v-if="isUserLoggedIn" class="nav-item dropdown form-inline">
          <div class="dropdown">
            <span class="font2">ยินดีต้อนรับ&nbsp;</span>
            <span
            ...
            <span class="font3" v-if="user.type == 'admin'"
              >&nbsp;&nbsp;<i class="fas fa-user-cog"></i> ผู้ดูเเลระบบ</span
            >
            <span class="font3" v-if="user.type == 'user'"
              >&nbsp;&nbsp;<i class="fas fa-user"></i> ผู้ใช้งาน</span
            >
            <div
            ...
            >
              ...
              <a
                ...
                ><i class="far fa-edit"></i> แก้ไขข้อมูล</a
              >
...
.bg-light {
  background-color: #31eefc !important;
  color: #fff !important;
}
.modal {
