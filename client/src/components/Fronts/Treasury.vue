<template>
  <div>
    ...
    <div class="header">
      <h3><i class="fas fa-th-list"></i> รายการห้องพัก</h3>
    </div>
    <div class="container-fluid">
      <div class="categories">
        <div style="width: 100%">
          <form class="form-inline form-search">
            <p class="font2">จำนวน: {{ results.length }} โรงเเรม</p>
            &nbsp;&nbsp;
            <div class="input-group mb-3" style="width: 20%">
              <input
                ...
                placeholder="ค้นหาโรงเเรม ,ราคาห้องพัก ,สถานะ"
      ...
      <span class="font3">
        ...
        <div id="blog-list-bottom">
          ...
          >
          ระบบจองห้องพักโรงเเรม พิษณุโลก
          </div>
        </div>
      </span>
    </div>
...
.input-group-text {
  background-color: #0ee240 !important;
  color: #fff;
}
.blog-load-finished {
  margin-top: 20px;
