<template>
  <div>
    ...
    <div class="header">
      <h3><i class="fas fa-tasks"></i> ข้อมูล</h3>
    </div>
    <div class="container-fluid">
      <div class="container">
        <div class="blog-wrapper">
          <h4>
            <i class="far fa-clipboard"></i> ข้อมูลของ
            {{ borrow.nameLend }}
          </h4>
          <hr />
          <br />
                    ...
                    <div class="col" align="left">
                      ...
                      <div class="input-group mb-3">
                        ...
                        <select v-model="borrow.status" required>
                          ...
                          <option value="อยู่ระหว่างการพิจารณา">อยู่ระหว่างการพิจารณา</option>
                          <option value="approved">อนุมัติ</option>
                          <option value="disapproved">ไม่อนุมัติ</option>
                          <option value="return">กลับคืน</option>
                        </select>
                      </div>
                    </div>
                    <br />
