<template>
  <div>
    ...
    <div class="header">
      <h3><i class="fas fa-box"></i> ข้อมูลการจองห้องพัก</h3>
    </div>
    <div class="container-fluid">
      <div class="container">
        <div class="blog-wrapper">
          <h4><i class="far fa-clipboard"></i> รายละเอียดการจองห้องพัก</h4>
          <br />
          <span class="font2">
            <form v-on:submit.prevent="createBorrow">
              <div class="row">
                <div class="col">
                  <label for="input1">ชื่อผู้ใช้งาน</label>
              ...
              <div class="row">
                <div class="col">
                  <label for="input1">เช็คอินเข้าห้องพัก</label>
                  <div class="input-group mb-3">
                    <div class="input-group-prepend">
                      <span class="input-group-text" id="basic-addon1"
                        ><i class="far fa-calendar-alt"></i
                ...
                <div class="col">
                  <label for="input1">เช็คเอ้าท์ออกห้องพัก</label>
                  <div class="input-group mb-3">
                    <div class="input-group-prepend">
                      <span class="input-group-text" id="basic-addon1"
              ...
              <div class="row">
                <div class="col">
                  <label for="input1">ห้องพักโรงเเรม</label>
                  <div class="input-group mb-3">
                    <div class="input-group-prepend">
                      <span class="input-group-text" id="basic-addon1"
                    ...
                    <select v-model="borrow.equipment" required>
                      <option disabled value="">เลือกห้องพักโรงเเรม</option>
                ...
                <div class="col">
                  ...
                  <div class="input-group mb-3">
                    ...
                    <input
                      ...
                      type="number"
                      class="form-control"
                      placeholder="หมายเลขโทรศัพท์ผู้ใช้งาน"
              ...
              >
                  ...
                  {{ borrow.equipment }}   {{ borrow.number }} 
                  {{ borrow.dateLend }} 
                  {{ borrow.dateReturn }}
                </p>
              </div>
