<template>
  <div>
    ...
    <div class="header">
      <h3><i class="fas fa-box-open"></i> เพิ่มโรงแรม</h3>
    </div>
    <div class="container-fluid">
      <div class="container">
        <div class="blog-wrapper">
          <h4><i class="fas fa-boxes"></i> รายละเอียดโรงแรม</h4>
          <br />
          <span class="font2">
            <form v-on:submit.prevent="createBlog">
              ...
              <br />
              <label for="exampleInputEmail1">รูปห้องพักโรงเเรม</label>
              <div class="blog-tab">
              ...
              <form enctype="multipart/form-data" novalidate>
                <div class="dropbox">
                  ...
                  <p v-if="isInitial">
                    เลือกไฟล์รูปภาพของคุณ
                    <br/> หรือคลิกเพื่อเรียกดูไฟล์
                  </p>
                  <p v-if="isSaving">อัปโหลด {{ fileCount }} ไฟล์...</p>
              ...
              <div class="form-group">
                ...
                <div class="input-group mb-3">
                  ...
                  <select v-model="blog.category" required>
                    <option disabled value="">เลทราคาห้องพัก</option>
                    <option value="ราคาประหยัดเริ่มต้น 300 บาท">ราคาประหยัดเริ่มต้น 300 บาท</option>
                    <option value="ราคาทั่วไปเริ่มต้น 500 บาท">ราคาทั่วไปเริ่มต้น 500 บาท</option>
                    <option value="ราคาห้องพักสุดหรูเริ่มต้น 1000 บาท">ราคาห้องพักสุดหรูเริ่มต้น 1000 บาท</option>
                  </select>
                </div>
              </div>
              <div class="form-group">
                ...
                <div class="input-group mb-3">
                  ...
                  <select v-model="blog.status" required>
                    ...
                    <option value="Yes">ว่าง</option>
                    <option value="No">ไม่ว่าง</option>
                  </select>
                </div>
              </div>
              <br />
