<template>
  <div v-if="isUserLoggedIn && user.type == 'admin'">
    ...
    <div class="header">
      <h3><i class="fas fa-th-list"></i> รายการโรงแรม</h3>
    </div>
    <div class="container">
      <div class="blog-header">
        <div class="create-blog" style="width: 100%">
                  ...
                  <span class="badge badge-primary" style="padding: 10px">
                    <div class="media" style="margin-top: 10px">
                      ...
                      <div class="media-body" style="text-indent: 1em">
                        <h4>ผู้ใช้งาน {{ users.length }}คน</h4>
                      </div>
                    </div>
                  </span>
                </td>
                <td width="30%" align="center">
                  <span class="badge badge-success" style="padding: 10px">
                    <div class="media" style="margin-top: 10px">
                      ...
                      <div class="media-body" style="text-indent: 1em">
                        <h4>จำนวนโรงเเรม{{ results.length }} </h4>
                      </div>
                    </div>
                  </span>
                </td>
                <td width="30%" align="center">
                  <span class="badge badge-danger" style="padding: 10px">
                    <div class="media" style="margin-top: 10px">
                      ...
                      <div class="media-body" style="text-indent: 1em">
                        <h4>รายการโรงแรม {{ borrows.length }} </h4>
                      </div>
                    </div>
                  </span>
                </td>
          ...
          <form class="form-inline form-search">
            <p class="font2">โรงเเรมทั้งหมด {{ results.length }}</p>
            &nbsp;&nbsp;
          ...
          >
            <i class="fas fa-plus-circle"></i> เพิ่มโรงแรม
          </button>
        </div>
        <br />
      ...
      <transition-group name="fade">
        <div v-for="blog in blogs" v-bind:key="blog.id" class="blog-list">
          ...
          <div class="blog-info">
            <p>
              <span class="font2">หมายเลขห้องพัก:</span> {{ blog.id }}<br />
              <span class="font2">ราคาห้องพัก:</span> {{ blog.category }}<br />
              <span class="font2">สถานะ:</span> {{ blog.status }}<br />
              <span class="font2">อัพเดทวันที่:</span>
