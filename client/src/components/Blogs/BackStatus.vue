  ...
  <div v-if="isUserLoggedIn && user.type == 'admin'">
    ...
    <div class="container-fluid">
      <div class="categories">
        <div>
          <p class="font2">จำนวน: {{ borrows.length }} </p>
        </div>
            ...
            <table class="table table-bordered" style="width: 100%">
              <thead class="table-bordered table-dark">
                <tr style="text-align: center">
                  ...
                  <th scope="col">วันเข้าห้องพัก</th>
                  <th scope="col">วันออกห้องพัก</th>
              ...
              <tbody>
                ...
                >
                  ...
                  >
                    <div
                      v-if="borrow.status == 'อยู่ระหว่างการพิจารณา'"
...
export default {
  ...
  methods: {
    ...
    async deleteBorrow(borrow) {
      try {
        let result = confirm("คุณต้องการยกเลิกการจองห้องพักของคุณหรือไม่?");
        if (result) {
